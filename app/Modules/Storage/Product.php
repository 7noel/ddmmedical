...
class Product extends Model implements Auditable {
	...
	protected $fillable = ['name', 'intern_code', 'provider_code', 'manufacturer_code', 'description', 'sub_category_id', 'unit_id', 'currency_id', 'country_id', 'brand_id', 'model', 'last_purchase', 'profit_margin', 'price', 'set_price', 'use_set_price', 'is_downloadable'];
